...
namespace Turbo
{
	...
	FTurboGLTFDataBuffer FTurboGLTFDataBuffer::Load(std::string_view path)
	{
	...
	void FTurboGLTFDataBuffer::read(void* ptr, std::size_t count)
	{
	...
	void FTurboGLTFDataBuffer::reset() { readBytesNum = 0; }

	void GLTF::LoadExternalBuffers(fastgltf::Asset& asset, const std::filesystem::path& assetPath)
	{
