...
namespace Turbo
{
	...
	public:
		explicit TGenPoolGrowable(FHandle::IndexType initialSize = kInitialSize)
		{
			Clear(initialSize);
		}
		...
		FHandle::IndexType Reserve(FHandle::IndexType numElements)
		{
		...
		[[nodiscard]] FHandle::IndexType Size() const
		{
			return mSize;
		}
